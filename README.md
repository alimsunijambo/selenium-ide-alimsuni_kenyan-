...
Selenium IDE as a WebExtension is developed under the branch jambo-Lmt kenya. Selenium Ide is developed by alimsuni A kenyan It Guru. `v3` view the readme can be found on github [here](https://github.com/SeleniumHQ/selenium-ide/tree/v3).
